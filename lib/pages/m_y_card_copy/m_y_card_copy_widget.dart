...
import '/components/sending_widget.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(4.0, 4.0, 4.0, 14.0),
                        child: Container(
                          width: 370.0,
                          height: 370.0,
                          decoration: BoxDecoration(
                                        ...
                                        child: FutureBuilder<List<WalletsRow>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<WalletsRow>
                                                textWalletsRowList =
                                                snapshot.data!;
                                            final textWalletsRow =
                                                textWalletsRowList.isNotEmpty
                                                    ? textWalletsRowList.first
                                                    : null;
                                            return Text(
                                              formatNumber(
                                                textWalletsRow!.balance!,
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(2.0, 15.0, 0.0, 10.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('selectwallet');
                              },
                              child: Container(
                                width: 170.0,
                                height: 100.0,
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(2.0, 10.0, 0.0, 15.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
