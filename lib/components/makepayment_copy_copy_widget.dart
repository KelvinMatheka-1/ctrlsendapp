...
import 'makepayment_copy_copy_model.dart';
export 'makepayment_copy_copy_model.dart';

class MakepaymentCopyCopyWidget extends StatefulWidget {
  const MakepaymentCopyCopyWidget({
    super.key,
    required this.allowancedetails,
  });

  final AllowancesRow? allowancedetails;

  @override
  State<MakepaymentCopyCopyWidget> createState() =>
      _MakepaymentCopyCopyWidgetState();
}

class _MakepaymentCopyCopyWidgetState extends State<MakepaymentCopyCopyWidget> {
  late MakepaymentCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MakepaymentCopyCopyModel());
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_model.dropDownValue == 'till no.')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child: Container(
                              ...
                              child: StreamBuilder<List<UserListRecord>>(
                                stream: queryUserListRecord(
                                  queryBuilder: (userListRecord) =>
                                    ...
                                    'email',
                                    isEqualTo:
                                        widget!.allowancedetails?.ownerEmail,
                                  ),
                                  singleRecord: true,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<UserListRecord>
                                      buttonUserListRecordList = snapshot.data!;
                                  ...
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      await TransactionsTable().insert({
                                        'sender_email': widget!
                                            .allowancedetails?.ownerEmail,
                                        'recipient_email': _model
                                            .emailAddressTextController3.text,
                                        'created_at': supaSerialize<DateTime>(
                                            getCurrentTimestamp),
                                        'amount': double.tryParse(_model
                                            .emailAddressTextController4.text),
                                        'status': 'pending',
